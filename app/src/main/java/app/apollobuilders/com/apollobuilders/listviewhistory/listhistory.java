 ...
 */
public class listhistory extends ArrayAdapter<String>{
    ...
    public listhistory(Activity context, ArrayList<String> date,ArrayList<String> subject) {
