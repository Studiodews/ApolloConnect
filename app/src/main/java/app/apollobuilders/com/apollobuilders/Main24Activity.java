...
public class Main24Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et1=(EditText)findViewById(R.id.editTextEmail3);
        et2=(EditText)findViewById(R.id.editTextCompliment);
        et3=(EditText)findViewById(R.id.editTextDetails3);
        et4=(EditText)findViewById(R.id.editTextLocation3);
    ...
    public void imgclk(View v)
    {
        ...
        if(c>5)
        {
            AlertDialog.Builder ab=new AlertDialog.Builder(Main24Activity.this);
        ...
        if(c==1)
        {
            try {
                ...
                if (b1 != null) {
                    ...
                    Toast.makeText(Main24Activity.this, "Try Again.", Toast.LENGTH_LONG).show();
                }
            }catch (Exception e)
            {}
        }
                ...
                if(!(et3.getText().toString().equals("")))
                {
                    ...
                    if(!(et4.getText().toString().equals("")))
                    {
                        ...
                        if(j1==1) {
                            ...
                            pic1="http://apollobuilders.co.in/apollo/ComplimentPics/"+imgname+".png";
                        ...
                        if(j2==1) {
                            ...
                            pic2="http://apollobuilders.co.in/apollo/ComplimentPics/"+imgname+".png";
                        ...
                        if(j3==1) {
                            ...
                            pic3="http://apollobuilders.co.in/apollo/ComplimentPics/"+imgname+".png";
                        }
                        ...
                        if(j4==1) {
                            ...
                            pic4="http://apollobuilders.co.in/apollo/ComplimentPics/"+imgname+".png";
                        }
                        ...
                        if(j5==1) {
                            ...
                            pic5="http://apollobuilders.co.in/apollo/ComplimentPics/"+imgname+".png";
    ...
    public class Asctask extends AsyncTask
    {
        ...
        protected void onPreExecute() {
            ...
            pd=new ProgressDialog(Main24Activity.this);
...
//            Log.d("picAddress5",pic5);
        ...
        protected Object doInBackground(Object[] params) {
            ...
            try {
                ...
                if((j1==1)||(j2==1)||(j3==1)||(j4==1)||(j5==1)) {
                    ...
                    HttpPost p = new HttpPost("http://apollobuilders.co.in/apollo/PicsUpCompliment.php");
                ...
                URL url=new URL("http://apollobuilders.co.in/apollo/Compliment.php?"+link);
        ...
        protected void onPostExecute(Object o) {
            ...
            pd.dismiss();
            Toast.makeText(Main24Activity.this, "Thanks for your compliment.", Toast.LENGTH_LONG).show();
            finish();
        }
