...
SharedPreferences s1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       stt= s1.getString("Stat", "LoggedOut");
        ...
        et2=(EditText)findViewById(R.id.editTextIssue);
        et3=(EditText)findViewById(R.id.editTextDetails);
        et4=(EditText)findViewById(R.id.editTextLocation);
    ...
    public void imgclk(View v)
    {
        ...
        if(c>5)
        {
            AlertDialog.Builder ab=new AlertDialog.Builder(Main22Activity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(c==1)
        {
            ...
            {
                Toast.makeText(Main22Activity.this, "Try Again.", Toast.LENGTH_LONG).show();
            }}
            catch (Exception e){}
        }
...
if(!(et5.getText().toString().equals(""))) {
                    ...
                    if (!(et3.getText().toString().equals(""))) {
                        ...
                        if (!(et4.getText().toString().equals(""))) {
                            ...
                            if (j1 == 1) {
                                ...
                                pic1 = "http://apollobuilders.co.in/apollo/IssuePics/" + imgname + ".png";
                            ...
                            if (j2 == 1) {
                                ...
                                pic2 = "http://apollobuilders.co.in/apollo/IssuePics/" + imgname + ".png";
                            ...
                            if (j3 == 1) {
                                ...
                                pic3 = "http://apollobuilders.co.in/apollo/IssuePics/" + imgname + ".png";
                            } else {
                                pic3 = null;
                            ...
                            if (j4 == 1) {
                                ...
                                pic4 = "http://apollobuilders.co.in/apollo/IssuePics/" + imgname + ".png";
                            } else {
                                pic4 = null;
                            ...
                            if (j5 == 1) {
                                ...
                                pic5 = "http://apollobuilders.co.in/apollo/IssuePics/" + imgname + ".png";
    ...
    public class Asctask extends AsyncTask
    {
        ...
        protected void onPreExecute() {
            ...
            pd=new ProgressDialog(Main22Activity.this);
...
//            Log.d("picAddress5",pic5);
        ...
        protected Object doInBackground(Object[] params) {
            ...
            try {
                ...
                if((j1==1)||(j2==1)||(j3==1)||(j4==1)||(j5==1)) {
                    ...
                    HttpPost p = new HttpPost("http://apollobuilders.co.in/apollo/PicsUpIssue.php");
                ...
                URL url=new URL("http://apollobuilders.co.in/apollo/Issue.php?"+link);
        ...
        protected void onPostExecute(Object o) {
            ...
            pd.dismiss();
            Toast.makeText(Main22Activity.this, "Your Issue Have been Registered You Will Get Updates Details via your Email.", Toast.LENGTH_LONG).show();
            finish();
        }
